...
def build_read_prologue_transform_stub(stub_va: int, debug_dump: bool) -> bytes:
    ...
    def find_or6_read_version(slot: int) -> None:
        ...
        b.jnz_label("found_or6_read_version")
        b.mov_reg_mem(b.ESI, b.ESP, slot)
        b.mov_reg_label_abs(b.EDI, "s_or6_3")
        b.call_label("find_next")
        b.test_reg_reg(b.EAX, b.EAX)
    ...
    def find_sw31_read_prologue() -> None:
        b.mov_mem_reg(b.ESP, 0x18, b.ESI)
        b.mov_reg_label_abs(b.EDI, "s_sw31")
        b.call_label("find_next")
        b.test_reg_reg(b.EAX, b.EAX)
        b.jnz_label("found_sw31_read_prologue")
        b.mov_reg_mem(b.ESI, b.ESP, 0x18)
        b.mov_reg_label_abs(b.EDI, "s_sw31_40")
        b.call_label("find_next")
        b.test_reg_reg(b.EAX, b.EAX)
        b.jz_label("transform_done")
        b.label("found_sw31_read_prologue")
    ...
    b.ascii_label("s_or6_3", "or\t$6,$0,3")
    b.ascii_label("s_sw19", "sw\t$19,32($sp)")
    b.ascii_label("s_sw31", "sw\t$31,36($sp)")
    b.ascii_label("s_sw31_40", "sw\t$31,40($sp)")
