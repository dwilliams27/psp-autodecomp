// gcDesiredObjectT<gcDesiredPoint, gcDesiredPointHelper, ePoint> - gcAll_psp.obj
//
// Functions matched here:
//   gcDesiredObjectT<...>::GetDesiredType(void) const   @ 0x0026c400 (296B)
//   gcDesiredObjectT<...>::GetText(char *) const        @ 0x0026c528 (264B)
...
// ── gcDesiredObjectT<...>::GetDesiredType(void) const @ 0x0026c400 ──
template <class T1, class T2, class T3>
const cType *gcDesiredObjectT<T1, T2, T3>::GetDesiredType(void) const {
    if (D_00046A4C == 0) {
        ...
        D_00046A4C = cType::InitializeType(
            ...
            (const char *)0x36DF5C, (const char *)0x36DF68, 0);
    }
    return D_00046A4C;
}

// ── gcDesiredObjectT<...>::GetText(char *) const @ 0x0026c528 ──
template <class T1, class T2, class T3>
