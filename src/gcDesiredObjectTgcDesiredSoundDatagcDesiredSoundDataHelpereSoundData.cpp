// gcDesiredObjectT<gcDesiredSoundData, gcDesiredSoundDataHelper, eSoundData> - gcAll_psp.obj
//
// Functions matched here:
//   gcDesiredObjectT<...>::GetDesiredType(void) const   @ 0x0026d4ec (292B)
//   gcDesiredObjectT<...>::GetText(char *) const        @ 0x0026d610 (264B)
...
// ── gcDesiredObjectT<...>::GetDesiredType(void) const @ 0x0026d4ec ──
template <class T1, class T2, class T3>
const cType *gcDesiredObjectT<T1, T2, T3>::GetDesiredType(void) const {
    if (D_00040F6C == 0) {
        ...
        D_00040F6C = cType::InitializeType(
            ...
            (const char *)0x36D978, (const char *)0x36D980, 1);
    }
    return D_00040F6C;
}

// ── gcDesiredObjectT<...>::GetText(char *) const @ 0x0026d610 ──
template <class T1, class T2, class T3>
void gcDesiredObjectT<T1, T2, T3>::GetText(char *buf) const {
    unsigned int v8 = *(unsigned int *)((const char *)this + 8);
    int flag = 0;
    if ((v8 & 1) != 0) flag = 1;
