...
//   gcDesiredSoundData::Read(cFile &, cMemPool *)            @ 0x001299d0
...
// 0x001299d0 - gcDesiredSoundData::Read(cFile &, cMemPool *)
int gcDesiredSoundData::Read(cFile &file, cMemPool *pool) {
    int result = 1;
    int rb[5];
    int inner[5];
