// gcValUIEnabled — decompiled from gcAll_psp.obj
// Methods in this file:
//   0x00361f50  New(cMemPool *, cBase *) static
//   0x0036213c  Write(cFile &) const
//   0x00362194  Read(cFile &, cMemPool *)
//   0x00362530  VisitReferences(unsigned int, cBase *, void (*)(cBase *, unsigned int, void *), void *, unsigned int)
//   0x003625b0  ~gcValUIEnabled(void)
//
...
extern char gcValUIEnabledvirtualtable[];
...
class gcValUIEnabled : public gcLValue {
public:
...
cBase *gcValUIEnabled::New(cMemPool *pool, cBase *parent) {
    ...
    gcValUIEnabled *result = 0;
    gcValUIEnabled *obj = (gcValUIEnabled *)e->fn(base, 0x14, 4, 0, 0);
    if (obj != 0) {
        ((void **)obj)[1] = gcLValuevirtualtable;
        ((cBase **)obj)[0] = parent;
        ((void **)obj)[1] = gcValUIEnabledvirtualtable;
...
// ── gcValUIEnabled::Write(cFile &) const @ 0x0036213c ──
void gcValUIEnabled::Write(cFile &file) const {
...
// ── gcValUIEnabled::Read(cFile &, cMemPool *) @ 0x00362194 ──
int gcValUIEnabled::Read(cFile &file, cMemPool *pool) {
    int result;
...
void gcValUIEnabled::VisitReferences(unsigned int flags, cBase *ctx, void (*cb)(cBase *, unsigned int, void *), void *user, unsigned int mask) {
    if (cb != 0) {
