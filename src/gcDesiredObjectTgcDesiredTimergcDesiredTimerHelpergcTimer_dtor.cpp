// gcDesiredObjectT<gcDesiredTimer, gcDesiredTimerHelper, gcTimer>::~gcDesiredObjectT(void)
// @ 0x002767f4, 240B, gcAll_psp.obj
//
...
// src/gcDesiredObjectTgcDesiredTimergcDesiredTimerHelpergcTimer.cpp
...
//
// ODR-WARNING: gcDesiredObjectT<gcDesiredTimer, gcDesiredTimerHelper,
// gcTimer> is also declared in the sibling TU above with a different
...
__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oQgcDesiredObjectT76OgcDesiredTimer6UgcDesiredTimerHelper6HgcTimer_dtv, 0xf0\n");
...
template gcDesiredObjectT<gcDesiredTimer, gcDesiredTimerHelper, gcTimer>::~gcDesiredObjectT(void);
