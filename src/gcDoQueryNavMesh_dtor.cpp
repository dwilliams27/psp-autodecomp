// gcDoQueryNavMesh_dtor.cpp - split TU for the destructor.
// ODR-WARNING: this TU re-declares gcDoQueryNavMesh locally with only the
// destructor + operator delete; the rest of the class lives in
// src/gcDoQueryNavMesh.cpp (New/GetType/AssignCopy/Write/Read). Adding a
...
inline void gcDoQueryNavMesh::operator delete(void *ptr) {
...
__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oQgcDoQueryNavMeshdtv, 0x1dc\n");

gcDoQueryNavMesh::~gcDoQueryNavMesh(void) {
    *(void **)((char *)this + 4) = gcDoQueryNavMeshvirtualtable;
