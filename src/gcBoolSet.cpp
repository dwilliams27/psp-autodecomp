...
inline void gcBoolSet::operator delete(void *p) {
    if (p != 0) {
...
__asm__(".size __0oJgcBoolSetdtv, 0x120\n");

// ============================================================
// 0x0023a0e4 — ~gcBoolSet(void)
// ============================================================
gcBoolSet::~gcBoolSet(void) {
    *(char **)((char *)this + 4) = (char *)0x386CD8;
