...
// for eReflectionModelMtl::Read. Do not add Read to include/eTextureMap.h just
...
struct eReflectionModelMtl_ReadEntry {
    short offset;
    short pad;
...
int eReflectionModelMtl::Read(cFile &file, cMemPool *pool) {
    int result;
...
success:
    ...
    *(int *)((char *)this + 0x4C) = 0;
    ...
    }
    {
        ...
        eReflectionModelMtl_ReadEntry *entry =
            (eReflectionModelMtl_ReadEntry *)((char *)desc + 0x30);
