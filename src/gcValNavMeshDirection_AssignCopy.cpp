// ODR-WARNING: split-TU local redeclaration for one gcValNavMeshDirection method.
...
extern cType *type_gcValNavMeshDirection asm("D_0009F8B0");

__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0fVgcValNavMeshDirectionKAssignCopyPC6FcBase, 0x310\n");

void gcValNavMeshDirection::AssignCopy(const cBase *base) {
    const gcValNavMeshDirection *other = 0;
    char *destValue = (char *)this + 0x34;
    ...
    if (base != 0) {
        if (!type_gcValNavMeshDirection) {
            ...
            type_gcValNavMeshDirection = cType::InitializeType(
                0, 0, 0xFA, type_value, gcValNavMeshDirection::New,
                0, 0, 0);
        }

        void *classDesc = *(void **)((const char *)base + 4);
        cType *wanted = type_gcValNavMeshDirection;
        ...
        if (ok != 0) {
            other = (const gcValNavMeshDirection *)base;
        }
    }
    ...
    if ((const char *)other + 0x34 != destValue) {
        int oldValue = *(int *)((char *)this + 0x34);
        int keep = 1;
        int tag = oldValue & 1;
        if (tag != 0) {
            keep = 0;
        ...
        int srcValue = *(int *)((const char *)other + 0x34);
        int cloneIt = 1;
        ...
        if (cloneIt != 0) {
            ...
            int current = *(int *)((char *)this + 0x34);
            int currentTagged = 0;
            cBase *cloneArg;
            if (current & 1) {
                currentTagged = 1;
    ...
    *(cNameData *)((char *)this + 0x40) =
        *(const cNameData *)((const char *)other + 0x40);

    *(int *)((char *)this + 0x58) =
        *(const int *)((const char *)other + 0x58);
    *(int *)((char *)this + 0x5C) =
        *(const int *)((const char *)other + 0x5C);
    *(int *)((char *)this + 0x60) =
