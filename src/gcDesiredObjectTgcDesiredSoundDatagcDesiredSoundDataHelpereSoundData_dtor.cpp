// gcDesiredObjectT<gcDesiredSoundData, gcDesiredSoundDataHelper, eSoundData>::~gcDesiredObjectT(void)
// @ 0x0026d9f4, 240B, gcAll_psp.obj
//
...
// src/gcDesiredObjectTgcDesiredSoundDatagcDesiredSoundDataHelpereSoundData.cpp
...
//
// ODR-WARNING: gcDesiredObjectT<gcDesiredSoundData, gcDesiredSoundDataHelper,
// eSoundData> is also declared in the sibling TU above with a different member
// list. The two TUs reference disjoint method sets and agree on the field
// offsets touched by the destructor.

class cBase;
class gcDesiredSoundData;
class gcDesiredSoundDataHelper;
class eSoundData;
...
__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oQgcDesiredObjectT76SgcDesiredSoundData6YgcDesiredSoundDataHelper6KeSoundData_dtv, 0xf0\n");
...
template class gcDesiredObjectT<gcDesiredSoundData, gcDesiredSoundDataHelper, eSoundData>;
