// gcValEntityHasTimeSince_dtor.cpp - split TU for the destructor.
...
// src/gcValEntityHasTimeSince.cpp. Keep the layout assumptions in sync
...
public:
    ...
    ~gcValEntityHasTimeSince(void);
};

extern char gcValEntityHasTimeSincevirtualtable[];

__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oXgcValEntityHasTimeSincedtv, 0x1dc\n");

gcValEntityHasTimeSince::~gcValEntityHasTimeSince(void) {
    *(void **)((char *)this + 4) = gcValEntityHasTimeSincevirtualtable;
