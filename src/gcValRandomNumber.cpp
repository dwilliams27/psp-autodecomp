...
inline void gcValRandomNumber::operator delete(void *p) {
...
__asm__(".size __0oRgcValRandomNumberdtv, 0x128\n");

gcValRandomNumber::~gcValRandomNumber() {
    *(char **)((char *)this + 4) = gcValRandomNumbervirtualtable;
