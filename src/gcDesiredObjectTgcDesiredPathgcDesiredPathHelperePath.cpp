// gcDesiredObjectT<gcDesiredPath, gcDesiredPathHelper, ePath> - gcAll_psp.obj
//
// Functions matched here:
//   gcDesiredObjectT<...>::GetDesiredType(void) const   @ 0x0026b2bc (296B)
//   gcDesiredObjectT<...>::GetText(char *) const        @ 0x0026b3e4 (264B)
...
// ── gcDesiredObjectT<...>::GetDesiredType(void) const @ 0x0026b2bc ──
template <class T1, class T2, class T3>
const cType *gcDesiredObjectT<T1, T2, T3>::GetDesiredType(void) const {
    if (D_00046A48 == 0) {
        ...
        D_00046A48 = cType::InitializeType(
            ...
            (const char *)0x36DCD0, (const char *)0x36DCD8, 0);
    }
    return D_00046A48;
}

// ── gcDesiredObjectT<...>::GetText(char *) const @ 0x0026b3e4 ──
template <class T1, class T2, class T3>
...
template class gcDesiredObjectT<gcDesiredPath, gcDesiredPathHelper, ePath>;
