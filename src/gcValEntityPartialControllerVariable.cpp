...
cBase *gcValEntityPartialControllerVariable::New(cMemPool *pool,
                                                 cBase *parent) {
    ...
    gcValEntityPartialControllerVariable *result = 0;
    gcValEntityPartialControllerVariable *obj =
        (gcValEntityPartialControllerVariable *)entry->fn(base, 0x50, 4, 0, 0);
    if (obj != 0) {
        ((void **)obj)[1] = (void *)0x37E6A8;
        {
            ...
            ((cBase **)obj)[0] = parent;
            __asm__ volatile("addiu %0,%0,0x79d0" : "+r"(type0));
            ((void **)obj)[1] = type0;
        }
        char *sub = (char *)obj + 8;
        ...
        ((int *)obj)[12] = sub_or_1;
        ((gcValEntityPartialControllerVariable **)obj)[13] = obj;
