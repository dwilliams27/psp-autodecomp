// gcValNavMeshDirection_dtor.cpp - split TU for the destructor.
// ODR-WARNING: this TU re-declares gcValNavMeshDirection locally with
// only the destructor + operator delete; the rest of the class lives in
// src/gcValNavMeshDirection.cpp. Keep the layout assumptions in sync
...
public:
    ...
    ~gcValNavMeshDirection(void);
};

extern char gcValNavMeshDirectionvirtualtable[];

__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oVgcValNavMeshDirectiondtv, 0x1C0\n");

gcValNavMeshDirection::~gcValNavMeshDirection(void) {
    *(void **)((char *)this + 4) = gcValNavMeshDirectionvirtualtable;
    ...
    if ((void *)p8 != 0) {
        *(void * volatile *)((char *)this + 0xC) = (void *)0x388A48;
