// gcDesiredObjectT<gcDesiredCustomAnimation, gcDesiredCustomAnimationHelper,
// gcEntityCustomAnimation> - gcAll_psp.obj
//
// Functions matched here:
//   gcDesiredObjectT<...>::GetDesiredType(void) const   @ 0x00265160 (296B)
//   gcDesiredObjectT<...>::GetText(char *) const        @ 0x00265288 (264B)
//
// Mirrors the gcDesiredEnumeration::GetText / gcDesiredEntityTemplate::
// GetDesiredType emit patterns; see those files for prior matched references.
...
// ── gcDesiredObjectT<...>::GetDesiredType(void) const @ 0x00265160 ──
template <class T1, class T2, class T3>
...
// ── gcDesiredObjectT<...>::GetText(char *) const @ 0x00265288 ──
template <class T1, class T2, class T3>
