...
cBase *gcValEntityHasTimeSince::New(cMemPool *pool, cBase *parent) {
    void *block = ((void **)pool)[9];
    char *allocTable = ((PoolBlock *)block)->allocTable;
    AllocEntry *entry = (AllocEntry *)(allocTable + 0x28);
    short off = entry->offset;
    void *base = (char *)block + off;
    gcValEntityHasTimeSince *result = 0;
    gcValEntityHasTimeSince *obj =
        (gcValEntityHasTimeSince *)entry->fn(base, 0x4C, 4, 0, 0);
    if (obj != 0) {
        ((void **)obj)[1] = (void *)0x37E6A8;
        {
            ...
            ((cBase **)obj)[0] = parent;
            __asm__ volatile("addiu %0,%0,0x72c8" : "+r"(type0));
            ((void **)obj)[1] = type0;
        }
        char *sub = (char *)obj + 8;
        ...
        ((int *)obj)[12] = sub_or_1;
        ((gcValEntityHasTimeSince **)obj)[13] = obj;
