// gcValEntitySoundFrequency_dtor.cpp - split TU for the destructor.
...
// src/gcValEntitySoundFrequency.cpp. Keep the layout assumptions in sync
...
public:
    ...
    ~gcValEntitySoundFrequency(void);
};

extern char gcValEntitySoundFrequencyvirtualtable[];

__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oZgcValEntitySoundFrequencydtv, 0x1C0\n");

gcValEntitySoundFrequency::~gcValEntitySoundFrequency(void) {
    *(void **)((char *)this + 4) = gcValEntitySoundFrequencyvirtualtable;
