// gcValEntityTimeSince_dtor.cpp - split TU for the destructor.
...
// src/gcValEntityTimeSince.cpp. Keep the layout assumptions in sync
...
public:
    ...
    ~gcValEntityTimeSince(void);
};

extern char gcValEntityTimeSincevirtualtable[];

__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oUgcValEntityTimeSincedtv, 0x1dc\n");

gcValEntityTimeSince::~gcValEntityTimeSince(void) {
    *(void **)((char *)this + 4) = gcValEntityTimeSincevirtualtable;
