...
extern cType *D_00046C24;
extern cType *D_00046CA8;
...
// ── eStandardGeomTrailMtl::GetType(void) const @ 0x0021b6a4 ──

const cType *eStandardGeomTrailMtl::GetType(void) const {
    if (D_00046CA8 == 0) {
        if (D_00046C24 == 0) {
            if (D_00040FF8 == 0) {
                if (D_00040FEC == 0) {
            ...
            D_00046C24 = cType::InitializeType(0, 0, 0x36, D_00040FF8,
                                               0, 0, 0, 0);
        }
        const cType *parentType = D_00046C24;
        cBase *(*factory)(cMemPool *, cBase *) =
            (cBase *(*)(cMemPool *, cBase *))0x21B628;
        __asm__ volatile("" : "+r"(parentType), "+r"(factory));
        D_00046CA8 = cType::InitializeType(0, 0, 0x37, parentType, factory,
                                           0, 0, 0);
    }
    return D_00046CA8;
}

// ── eStandardGeomTrailMtl::eStandardGeomTrailMtl(cBase *) @ 0x000879a8 ──

extern "C" void eGeomMtl_eGeomMtl(void *, cBase *);

extern char eStandardGeomTrailMtlclassdesc[];

eStandardGeomTrailMtl::eStandardGeomTrailMtl(cBase *parent) {
    eGeomMtl_eGeomMtl(this, parent);
    ((int *)this)[0x68 / 4] = -1;
    ((void **)this)[0x04 / 4] = eStandardGeomTrailMtlclassdesc;
    ((int *)this)[0x6C / 4] = 0;
    ((int *)this)[0x70 / 4] = 0;
    CreateData();
}
