// gcDesiredObjectT<gcDesiredStringTable, gcDesiredStringTableHelper, gcStringTable>::~gcDesiredObjectT(void)
// @ 0x0026fc7c, 240B, gcAll_psp.obj
//
...
// src/gcDesiredObjectTgcDesiredStringTablegcDesiredStringTableHelpergcStringTable.cpp
...
//
// ODR-WARNING: gcDesiredObjectT<gcDesiredStringTable, gcDesiredStringTableHelper,
// gcStringTable> is also declared in the sibling TU above with a different
...
__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oQgcDesiredObjectT76UgcDesiredStringTable6agcDesiredStringTableHelper6NgcStringTable_dtv, 0xf0\n");
...
template gcDesiredObjectT<gcDesiredStringTable, gcDesiredStringTableHelper, gcStringTable>::~gcDesiredObjectT(void);
