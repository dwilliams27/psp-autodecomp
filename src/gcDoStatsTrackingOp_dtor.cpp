// gcDoStatsTrackingOp_dtor.cpp - split TU for the destructor.
// ODR-WARNING: this TU re-declares gcDoStatsTrackingOp locally with only the
// destructor + operator delete; the rest of the class lives in
// src/gcDoStatsTrackingOp.cpp (New/GetType/AssignCopy/Write/GetText). Adding
...
inline void gcDoStatsTrackingOp::operator delete(void *ptr) {
...
__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oTgcDoStatsTrackingOpdtv, 0x1dc\n");

gcDoStatsTrackingOp::~gcDoStatsTrackingOp(void) {
    *(void **)((char *)this + 4) = gcDoStatsTrackingOpvirtualtable;
