// gcValEntityPathDistance_dtor.cpp - split TU for the destructor.
// ODR-WARNING: this TU re-declares gcValEntityPathDistance locally with
// only the destructor + operator delete; the rest of the class lives in
// src/gcValEntityPathDistance.cpp. Keep the layout assumptions in sync if
// either file changes.
...
public:
    ...
    ~gcValEntityPathDistance(void);
};

__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oXgcValEntityPathDistancedtv, 0x1c0\n");

gcValEntityPathDistance::~gcValEntityPathDistance(void) {
    register void *vt asm("a0");
    __asm__ volatile("lui %0,0x0\n\taddiu %0,%0,0x7b98" : "=r"(vt));
    *(void **)((char *)this + 4) = vt;
