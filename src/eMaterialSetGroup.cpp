...
// ── eMaterialSetGroup::GetManagedType(void) const @ 0x000154c8 ──
const cType *eMaterialSetGroup::GetManagedType(void) const {
    if (D_00040FF0 == 0) {
        if (D_000385E4 == 0) {
            if (D_000385E0 == 0) {
                if (D_000385DC == 0) {
...
// ── eMaterialSetGroup::GetDataDirectory(void) const @ 0x000155ec ──
const char *eMaterialSetGroup::GetDataDirectory(void) const {
    if (D_00040FF0 == 0) {
        if (D_000385E4 == 0) {
            if (D_000385E0 == 0) {
                if (D_000385DC == 0) {
