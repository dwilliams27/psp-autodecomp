...
inline void gcDoRecord::operator delete(void *ptr) {
...
int gcDoRecord::Read(cFile &file, cMemPool *pool) {
    int result = 1;
    int rb[5];
...
gcDoRecord::~gcDoRecord(void) {
    *(void **)((char *)this + 4) = gcDoRecordvirtualtable;
