// gcValLookAtControllerVariable_dtor.cpp - split TU for the destructor.
// ODR-WARNING: this TU re-declares gcValLookAtControllerVariable locally with
// only the destructor + operator delete; the rest of the class lives in
// src/gcValLookAtControllerVariable.cpp. Keep the layout assumptions in sync
...
public:
    ...
    ~gcValLookAtControllerVariable(void);
};

__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0odgcValLookAtControllerVariabledtv, 0x1dc\n");

gcValLookAtControllerVariable::~gcValLookAtControllerVariable(void) {
    register void *vt asm("a0");
    __asm__ volatile("lui %0,0x0\n\taddiu %0,%0,0x78e8" : "=r"(vt));
    *(void **)((char *)this + 4) = vt;
