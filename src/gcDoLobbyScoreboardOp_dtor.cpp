// gcDoLobbyScoreboardOp_dtor.cpp - split TU for the destructor.
// ODR-WARNING: gcDoLobbyScoreboardOp is also defined in
// src/gcDoLobbyScoreboardOp.cpp. This TU redeclares only the destructor
...
inline void gcDoLobbyScoreboardOp::operator delete(void *ptr) {
...
__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oVgcDoLobbyScoreboardOpdtv, 0x28c\n");

gcDoLobbyScoreboardOp::~gcDoLobbyScoreboardOp(void) {
    *(void **)((char *)this + 4) = gcDoLobbyScoreboardOpvirtualtable;
