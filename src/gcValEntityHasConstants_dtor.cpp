// gcValEntityHasConstants_dtor.cpp - split TU for the destructor.
// ODR-WARNING: this TU re-declares gcValEntityHasConstants locally with only
// the destructor + operator delete. The matched siblings live in
// src/gcValEntityHasConstants.cpp; keep the layout assumptions in sync if
// either file changes.
...
public:
    ...
    ~gcValEntityHasConstants(void);
};

extern char gcValEntityHasConstantsvirtualtable[];

inline void gcValEntityHasConstants::operator delete(void *ptr) {
...
__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oXgcValEntityHasConstantsdtv, 0x168\n");

gcValEntityHasConstants::~gcValEntityHasConstants(void) {
    *(void **)((char *)this + 4) = gcValEntityHasConstantsvirtualtable;
