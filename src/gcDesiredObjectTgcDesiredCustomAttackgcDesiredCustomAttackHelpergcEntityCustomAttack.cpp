// gcDesiredObjectT<gcDesiredCustomAttack, gcDesiredCustomAttackHelper,
// gcEntityCustomAttack> - gcAll_psp.obj
//
// Functions matched here:
//   gcDesiredObjectT<...>::GetDesiredType(void) const   @ 0x00266824 (296B)
//   gcDesiredObjectT<...>::GetText(char *) const        @ 0x0026694c (264B)
//
// Mirrors the gcDesiredObjectT<gcDesiredCustomAnimation,...> emit pattern;
// see that file for prior matched references.
...
// ── gcDesiredObjectT<...>::GetDesiredType(void) const @ 0x00266824 ──
template <class T1, class T2, class T3>
...
// ── gcDesiredObjectT<...>::GetText(char *) const @ 0x0026694c ──
template <class T1, class T2, class T3>
