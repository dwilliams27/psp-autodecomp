// gcValEntityIsValid_dtor.cpp - split TU for the destructor.
// ODR-WARNING: this TU re-declares gcValEntityIsValid locally with
// only the destructor + operator delete; the rest of the class lives in
// src/gcValEntityIsValid.cpp. Keep layout assumptions in sync.
...
public:
    ...
    ~gcValEntityIsValid(void);
};

__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oSgcValEntityIsValiddtv, 0x23c\n");

gcValEntityIsValid::~gcValEntityIsValid(void) {
    register void *vt asm("a0");
    __asm__ volatile("lui %0,0x0\n\taddiu %0,%0,0x7808" : "=r"(vt));
    *(void **)((char *)this + 4) = vt;
    ...
    if ((void *)p38 != 0) {
        *(void **)((char *)this + 0x3C) = (void *)0x389508;
