// gcDesiredObjectT<gcDesiredTableTemplate, gcDesiredTableTemplateHelper, gcTableTemplate>::~gcDesiredObjectT(void)
// @ 0x00274d58, 240B, gcAll_psp.obj
//
...
// src/gcDesiredObjectTgcDesiredTableTemplategcDesiredTableTemplateHelpergcTableTemplate.cpp
...
//
// ODR-WARNING: gcDesiredObjectT<gcDesiredTableTemplate,
// gcDesiredTableTemplateHelper, gcTableTemplate> is also declared in the
// sibling TU above with a different member list. The two TUs reference
// disjoint method sets and agree on the field offsets touched by the
// destructor.
...
__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oQgcDesiredObjectT76WgcDesiredTableTemplate6cgcDesiredTableTemplateHelper6PgcTableTemplate_dtv, 0xf0\n");
...
template gcDesiredObjectT<gcDesiredTableTemplate, gcDesiredTableTemplateHelper, gcTableTemplate>::~gcDesiredObjectT(void);
