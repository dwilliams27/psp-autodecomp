// cArrayBase<cHandleT<gcEntityCustomAnimation>>::operator=(const cArrayBase<cHandleT<gcEntityCustomAnimation>>&)
// @ 0x00241684, gcAll_psp.obj
...
template cArrayBase<cHandleT<gcEntityCustomAnimation> > &
cArrayBase<cHandleT<gcEntityCustomAnimation> >::operator=(
    const cArrayBase<cHandleT<gcEntityCustomAnimation> > &);
