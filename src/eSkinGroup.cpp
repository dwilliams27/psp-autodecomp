...
// ── eSkinGroup::GetManagedType(void) const @ 0x000182B8 ──
const cType *eSkinGroup::GetManagedType(void) const {
    if (D_000469F8 == 0) {
        if (D_000385E4 == 0) {
            if (D_000385E0 == 0) {
                if (D_000385DC == 0) {
...
// ── eSkinGroup::GetDataDirectory(void) const @ 0x000183E0 ──
const char *eSkinGroup::GetDataDirectory(void) const {
    if (D_000469F8 == 0) {
        if (D_000385E4 == 0) {
            if (D_000385E0 == 0) {
                if (D_000385DC == 0) {
