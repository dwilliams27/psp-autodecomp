...
static cType *type_gcValEntityConstant asm("D_0009F7F8");

const cType *gcValEntityConstant::GetType(void) const {
    if (!type_gcValEntityConstant) {
        ...
        type_gcValEntityConstant = cType::InitializeType(
            0, 0, 0xD4, type_value, gcValEntityConstant::New, 0, 0, 0);
    }
    return type_gcValEntityConstant;
}

cBase *gcValEntityConstant::New(cMemPool *pool, cBase *parent) {
    void *block = ((void **)pool)[9];
    char *allocTable = ((PoolBlock *)block)->allocTable;
    AllocEntry *entry = (AllocEntry *)(allocTable + 0x28);
    short off = entry->offset;
    void *base = (char *)block + off;
    gcValEntityConstant *result = 0;
    gcValEntityConstant *obj =
        (gcValEntityConstant *)entry->fn(base, 0x4C, 4, 0, 0);
    if (obj != 0) {
        ((void **)obj)[1] = (void *)0x37E6A8;
        {
            ...
            ((cBase **)obj)[0] = parent;
            __asm__ volatile("addiu %0,%0,0x6d80" : "+r"(type0));
            ((void **)obj)[1] = type0;
        }
        char *sub = (char *)obj + 8;
        ...
        ((int *)obj)[12] = sub_or_1;
        ((gcValEntityConstant **)obj)[13] = obj;
