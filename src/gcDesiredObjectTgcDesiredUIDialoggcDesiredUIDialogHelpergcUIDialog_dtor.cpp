// gcDesiredObjectT<gcDesiredUIDialog, gcDesiredUIDialogHelper, gcUIDialog>::~gcDesiredObjectT(void)
// @ 0x00279874, 240B, gcAll_psp.obj
//
...
// src/gcDesiredObjectTgcDesiredUIDialoggcDesiredUIDialogHelpergcUIDialog.cpp
...
//
// ODR-WARNING: gcDesiredObjectT<gcDesiredUIDialog, gcDesiredUIDialogHelper, gcUIDialog>
...
__asm__(".word 0x1000ffff\n"
        ".word 0x00000000\n"
        ".size __0oQgcDesiredObjectT76RgcDesiredUIDialog6XgcDesiredUIDialogHelper6KgcUIDialog_dtv, 0xf0\n");
...
template class gcDesiredObjectT<gcDesiredUIDialog, gcDesiredUIDialogHelper, gcUIDialog>;
