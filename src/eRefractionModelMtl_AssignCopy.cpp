// ODR-WARNING: this TU intentionally redeclares eRefractionModelMtl with a
// minimal member list because include/eTextureMap.h does not yet declare
// AssignCopy. Keep this split from src/eRefractionModelMtl.cpp so existing
